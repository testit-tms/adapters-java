...
public class WorkflowsApi {
   ...
   */
  public ApiResponse<WorkflowApiResult> adaptersWorkflowsIdGetWithHttpInfo(UUID id) throws ApiException {
    // Check required parameters
    if (id == null) {
      throw new ApiException(400, "Missing the required parameter 'id' when calling adaptersWorkflowsIdGet");
    }

    // Path parameters
    String localVarPath = "/adapters/workflows/{id}"
