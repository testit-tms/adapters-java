...
public class WorkItemsApi {
   ...
   */
  public ApiResponse<WorkItemApiResult> adaptersWorkItemsIdGetWithHttpInfo(String id, UUID versionId, Integer versionNumber) throws ApiException {
   ...
   */
  public List<WorkItemShortApiResult> adaptersWorkItemsSearchPost(Integer skip, Integer take, String orderBy, String searchField, String searchValue, WorkItemSelectApiModel workItemSelectApiModel) throws ApiException {
   ...
   */
  public ApiResponse<List<WorkItemShortApiResult>> adaptersWorkItemsSearchPostWithHttpInfo(Integer skip, Integer take, String orderBy, String searchField, String searchValue, WorkItemSelectApiModel workItemSelectApiModel) throws ApiException {
    // Query parameters
    List<Pair> localVarQueryParams = new ArrayList<>(
