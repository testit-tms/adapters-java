...
public class LinkUpdateApiModel {
  ...
  public LinkUpdateApiModel url(@jakarta.annotation.Nonnull String url) {
    this.url = url;
    return this;
  }
  ...
  public LinkUpdateApiModel id(@jakarta.annotation.Nullable UUID id) {
  ...
  public LinkUpdateApiModel title(@jakarta.annotation.Nullable String title) {
  ...
  public LinkUpdateApiModel description(@jakarta.annotation.Nullable String description) {
