...
public class CreateLinkApiModel {
  ...
  public CreateLinkApiModel url(@jakarta.annotation.Nonnull String url) {
    this.url = url;
    return this;
  }
  ...
  public CreateLinkApiModel type(@jakarta.annotation.Nonnull LinkType type) {
    this.type = type;
    return this;
  }
  ...
  public CreateLinkApiModel title(@jakarta.annotation.Nullable String title) {
  ...
  public CreateLinkApiModel description(@jakarta.annotation.Nullable String description) {
